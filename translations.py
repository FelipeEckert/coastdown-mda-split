...
TRANSLATIONS = {
    ...
    "split_deviation_times_title": {"pt": "Tempos deltaT", "en": "DeltaT times"},
    "split_deviation_group": {"pt": "Grupo", "en": "Group"},
    "split_deviation_mean_time": {"pt": "Média deltaT [s]", "en": "Mean deltaT [s]"},
    "split_deviation_speed": {"pt": "Velocidade", "en": "Speed"},
    "split_deviation_mean_plus": {"pt": "Média [+] [s]", "en": "Mean [+] [s]"},
    "split_deviation_mean_minus": {"pt": "Média [-] [s]", "en": "Mean [-] [s]"},
    "split_deviation_difference_pct": {"pt": "Diferença [%]", "en": "Difference [%]"},
