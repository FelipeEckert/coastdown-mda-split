...
def calculate_single_pair_corrected_data(
    ...
    """Compatibility wrapper for the canonical correction implementation."""
    from .corrections import _calculate_single_pair_corrected_data as correct_pair
...
def calculate_single_pair_corrected_data2(
    ...
    """Compatibility wrapper for the raw-value correction adapter."""
    from .corrections import _calculate_single_pair_corrected_data2 as correct_pair
