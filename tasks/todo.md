...
- [ ] Finding 18 Batch 2: retire pages 1, 3, and 4 with `_legacy_method_state.py` after explicitly ending their direct-import/blank-route compatibility contract.
- [ ] Finding 18 Batch 3: audit newly unreferenced Standard adapters, lazy public exports, tests, and translation families without touching Split formulas.
...
- [x] Stop eager Standard imports from `core/__init__.py` and `data/__init__.py` while preserving public compatibility through lazy exports.
...
- [ ] Keep `core/corrections.py`, `data/exporters.py` and pages 3-4 isolated as Standard legacy; pages 5-6 and `utils/pair_time_analysis.py` were removed in finding 18 Batch 1.
