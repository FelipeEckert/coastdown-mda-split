...
- [ ] Finding 18 Batch 1: remove legacy `page_5_comparativo.py` and `page_6_resultados.py`, then remove `utils/pair_time_analysis.py` only after a final caller check.
